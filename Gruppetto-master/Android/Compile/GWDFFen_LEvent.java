...
public class GWDFFen_LEvent extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de Fen_LEvent
////////////////////////////////////////////////////////////////////////////

/**
 * txt_event
 */
class GWDtxt_event extends WDChampSaisieMultiLigne
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de Fen_LEvent.txt_event
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setRectLibelle(0,2,44,42);
super.setRectCompPrincipal(44,2,198,42);
super.setQuid(3309329373278366198l);

super.setChecksum("955459008");

super.setNom("txt_event");
...
super.setTailleInitiale(46, 242);
...
public GWDtxt_event mWD_txt_event;
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de Fen_LEvent.FLOTTANT
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309329454887679694l);

super.setChecksum("960386953");
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de Fen_LEvent.Table1
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de Fen_LEvent.Table1.id
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309329652461136666l);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de Fen_LEvent.Table1.nom
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309329652461267754l);
...
/**
 * Initialise tous les champs de Fen_LEvent.Table1
 */
public void initialiserSousObjets()
{
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de Fen_LEvent.Table1
////////////////////////////////////////////////////////////////////////////
...
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309329652460940058l);

super.setChecksum("965154027");
...
super.setPositionInitiale(62, 0);

super.setTailleInitiale(345, 320);
...
// ouvre(FEN_PEvent,Table1[Table1].id)
WDAPIFenetre.ouvre(GWDPGruppeto.getInstance().mWD_FEN_PEvent,new WDObjet[] {this.get(this).get("id")} );
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de Fen_LEvent.#EXPRESSVersion
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3308456919467200612l);

super.setChecksum("1030788550");
...
// Pas de traitement pour le champ Fen_LEvent.#EXPRESSVersion
...
////////////////////////////////////////////////////////////////////////////
// Procédures utilisateur de Fen_LEvent
////////////////////////////////////////////////////////////////////////////
...
{
// 			Table1.AjouteLigne(evt.idEvent..Valeur,evt.nomE..Valeur)
WDAPITable.tableAjouteLigne(mWD_Table1,new Object[] {parcours1.getVariableParcours().get("idEvent").getProp(EWDPropriete.PROP_VALEUR),parcours1.getVariableParcours().get("nomE").getProp(EWDPropriete.PROP_VALEUR)} );
...
{
WDObjet vWD_evt = WDParcoursFactory.creerVariableParcours(vWD_vCTest);
parcours2 = WDParcoursFactory.pourTout(vWD_vCTest, vWD_evt, null, null, null, 0x0, 0x2);
while(parcours2.testParcours())
{
// 			SI evt.nom..Valeur =  txt_event ALORS
if(parcours2.getVariableParcours().get("nom").getProp(EWDPropriete.PROP_VALEUR).opEgal(mWD_txt_event))
{
// 				i = Vrai
vWD_i.setValeur(true);

// 				Table1.AjouteLigne(evt.idEvent..Valeur,evt.nomE..Valeur)
WDAPITable.tableAjouteLigne(mWD_Table1,new Object[] {parcours2.getVariableParcours().get("idEvent").getProp(EWDPropriete.PROP_VALEUR),parcours2.getVariableParcours().get("nomE").getProp(EWDPropriete.PROP_VALEUR)} );
...
{
// 			Info ("Evènement inexistant. Vérifier l'orthographe !")	
WDAPIDialogue.info("Evènement inexistant. Vérifier l'orthographe !");
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de Fen_LEvent.ActionBar
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
/**
 * Traitement: Déclarations globales de Fen_LEvent
 */
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre Fen_LEvent
////////////////////////////////////////////////////////////////////////////
protected void creerChamps()
{
mWD_txt_event = new GWDtxt_event();
...
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre Fen_LEvent
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.setQuid(3308456919467135061l);

super.setChecksum("1035111640");

super.setNom("Fen_LEvent");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de Fen_LEvent
////////////////////////////////////////////////////////////////////////////
mWD_txt_event.initialiserObjet();
super.ajouter("txt_event", mWD_txt_event);
...
{
return GWDPGruppeto.getInstance().mWD_Fen_LEvent;
}
}
/**

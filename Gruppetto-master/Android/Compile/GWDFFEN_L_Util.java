...
public class GWDFFEN_L_Util extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de FEN_L_Util
////////////////////////////////////////////////////////////////////////////

/**
 * txt_nom
 */
class GWDtxt_nom extends WDChampSaisieSimple
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_L_Util.txt_nom
////////////////////////////////////////////////////////////////////////////
...
super.setRectCompPrincipal(44,2,195,40);
super.setQuid(3309295653388230908l);

super.setChecksum("853548905");

super.setNom("txt_nom");
...
super.setTailleInitiale(44, 239);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_L_Util.FLOTTANT
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309295679162627891l);

super.setChecksum("858143030");
 ...
 * tab_util
 */
class GWDtab_util extends WDTable
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_L_Util.tab_util
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_L_Util.tab_util.id
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309296031356057928l);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_L_Util.tab_util.prenom
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309296031356189016l);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_L_Util.tab_util.nom
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309296035651287399l);
...
/**
 * Initialise tous les champs de FEN_L_Util.tab_util
 */
public void initialiserSousObjets()
{
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_L_Util.tab_util
////////////////////////////////////////////////////////////////////////////
...
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3309296031355861320l);

super.setChecksum("864060549");

super.setNom("tab_util");
...
super.setTailleInitiale(347, 320);
...
/**
 * Traitement: Double Tap / Bouton gauche double-clic sur tab_util
 */
public void doubleClicSurBoutonGauche()
{
super.doubleClicSurBoutonGauche();

// Ouvre(Fen_LieuUtil,tab_util[tab_util].id)
WDAPIFenetre.ouvre(GWDPGruppeto.getInstance().mWD_Fen_LieuUtil,new WDObjet[] {this.get(this).get("id")} );
...
public GWDtab_util mWD_tab_util;
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de FEN_L_Util.#EXPRESSVersion
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(3308458057639369878l);

super.setChecksum("1036624641");
...
// Pas de traitement pour le champ FEN_L_Util.#EXPRESSVersion
...
////////////////////////////////////////////////////////////////////////////
// Procédures utilisateur de FEN_L_Util
////////////////////////////////////////////////////////////////////////////
...
{
// 		Tab_util.SupprimeTout()
WDAPITable.tableSupprimeTout(mWD_tab_util);
...
{
// 			tab_util.AjouteLigne(util.idUtil..Valeur,util.prenom..Valeur, util.nom..Valeur)
WDAPITable.tableAjouteLigne(mWD_tab_util,new Object[] {parcours1.getVariableParcours().get("idUtil").getProp(EWDPropriete.PROP_VALEUR),parcours1.getVariableParcours().get("prenom").getProp(EWDPropriete.PROP_VALEUR),parcours1.getVariableParcours().get("nom").getProp(EWDPropriete.PROP_VALEUR)} );
...
{
WDObjet vWD_util = WDParcoursFactory.creerVariableParcours(vWD_vCTest);
parcours2 = WDParcoursFactory.pourTout(vWD_vCTest, vWD_util, null, null, null, 0x0, 0x2);
while(parcours2.testParcours())
{
// 			SI util.nom..Valeur = txt_nom ALORS
if(parcours2.getVariableParcours().get("nom").getProp(EWDPropriete.PROP_VALEUR).opEgal(mWD_txt_nom))
{
// 				i = Vrai
vWD_i.setValeur(true);

// 				tab_util.AjouteLigne(util.idUtil..Valeur,util.prenom..Valeur, util.nom..Valeur)
WDAPITable.tableAjouteLigne(mWD_tab_util,new Object[] {parcours2.getVariableParcours().get("idUtil").getProp(EWDPropriete.PROP_VALEUR),parcours2.getVariableParcours().get("prenom").getProp(EWDPropriete.PROP_VALEUR),parcours2.getVariableParcours().get("nom").getProp(EWDPropriete.PROP_VALEUR)} );
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_L_Util.ActionBar
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
/**
 * Traitement: Déclarations globales de FEN_L_Util
 */
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre FEN_L_Util
////////////////////////////////////////////////////////////////////////////
protected void creerChamps()
{
mWD_txt_nom = new GWDtxt_nom();
mWD_FLOTTANT = new GWDFLOTTANT();
mWD_tab_util = new GWDtab_util();
mWD__EXPRESSVersion = new GWD_EXPRESSVersion();
mWD_ActionBar = new GWDActionBar();

}
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre FEN_L_Util
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.setQuid(3308458057639304342l);

super.setChecksum("1040947746");

super.setNom("FEN_L_Util");
...
super.setTitre("Liste des Utilisateurs");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_L_Util
////////////////////////////////////////////////////////////////////////////
mWD_txt_nom.initialiserObjet();
super.ajouter("txt_nom", mWD_txt_nom);
mWD_FLOTTANT.initialiserObjet();
super.ajouter("FLOTTANT", mWD_FLOTTANT);
mWD_tab_util.initialiserObjet();
super.ajouter("tab_util", mWD_tab_util);
...
{
return GWDPGruppeto.getInstance().mWD_FEN_L_Util;
}
}
/**
